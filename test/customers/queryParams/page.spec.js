...
describe('List Customers Based on "page" Query Parameter', () => {
  beforeAll(async () => {
  ...
  it('should return the first customer page if page is not sent in the query parameter', async () => {
  ...
  it('should return customers on page 1', async () => {
    const response = await request(app)
      .get('/customers')
      .set('Authorization', `Bearer ${token}`);
