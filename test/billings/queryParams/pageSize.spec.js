...
describe('List Billings Based on "page_size" Query Parameter', () => {
  beforeAll(async () => {
  ...
  it('should return billings with a page_size of 2', async () => {
  ...
  it('should fail if page_size is not a positive integer', async () => {
    ...
    expect(response.body).toHaveProperty(
      ...
      'page_size deve ser um número inteiro',
    );
  });
});
